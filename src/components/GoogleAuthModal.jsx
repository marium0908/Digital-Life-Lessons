          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-6 flex flex-col justify-between flex-1">
            <div className="space-y-4 text-center">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 border border-slate-200 dark:bg-zinc-900 dark:border-zinc-800 rounded-full text-xs font-medium text-slate-700 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-850 shrink-0 transition"
                >
            ...
            <div className="flex items-center justify-between pt-6 mt-2">
              <button
                type="button"
                onClick={() => setStep('email')}
                className="text-xs font-semibold text-[#1a73e8] dark:text-[#8ab4f8] hover:bg-slate-50 dark:hover:bg-zinc-900 px-3 py-2 rounded transition cursor-pointer"
              >
                Go back
              </button>
